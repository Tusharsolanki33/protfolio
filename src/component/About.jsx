...
import profileImage from '../assets/tushar.jpg';
    ...
    >
      <div className="flex flex-col-reverse md:flex-row justify-between items-center">
        ...
        <div className="md:w-1/2 text-center md:text-left mt-8 md:mt-0">
          ...
          {/* Resume Button */}
          <a
            href="https://drive.google.com/file/d/1sJLvfsUMdLDj2A_aK8JXcoVJ8is7wQxK/view?usp=drive_link"
            target="_blank"
